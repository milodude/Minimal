...
// in coda_test/test/features/clients/data/data_source/client_data_source_test.dart.
...
import 'package:coda_test/core/provider/url_provider.dart' as _i9;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockUrlProvider extends _i1.Mock implements _i9.UrlProvider {
  MockUrlProvider() {
    _i1.throwOnMissingStub(this);
  }
  ...
  Uri getUrl(String? path, Map<String, dynamic>? params) =>
      (super.noSuchMethod(Invocation.method(#getUrl, [path, params]),
